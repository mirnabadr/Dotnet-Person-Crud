                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 ${errors.firstName ? 'border-red-500' : 'border-gray-200'}`}
                    ...
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 ${errors.lastName ? 'border-red-500' : 'border-gray-200'}`}
                        ...
                        {errors.lastName?.type === 'maxLength' && (
                            <p className="mt-1 text-sm text-red-600 flex items-center">
                                Last name can not exceed 30 characters
                            </p>
                        )}
                    </div>
                </div>
